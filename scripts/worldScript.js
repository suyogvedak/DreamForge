  ...
  if (saveBtn) {
    saveBtn.addEventListener('click', async () => {
      ...
      try {
        ...
        const r = await fetch('/api/save', { method: 'POST', headers, body: JSON.stringify({ theme: 'worlds', type: 'world', payload }) });
